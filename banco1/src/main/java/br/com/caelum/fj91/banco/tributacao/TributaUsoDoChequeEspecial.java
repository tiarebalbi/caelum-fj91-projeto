 ...
 */
public class TributaUsoDoChequeEspecial implements Imposto  {
	
	/* (non-Javadoc)
	 * @see br.com.caelum.fj91.banco.tributacao.Imposto#calculaDesconto(br.com.caelum.fj91.banco.modelo.Conta)
	 */
	@Override
