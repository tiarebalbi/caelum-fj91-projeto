...
public class Programa {
	...
	//a implementação atual do NativeArray implementa a interface List
	//https://github.com/mozilla/rhino/blob/master/src/org/mozilla/javascript/NativeArray.java
